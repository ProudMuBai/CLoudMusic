...
//注册获取用户唯一标识的接口
app.use('/getOpenId',async (req,resp,next) =>{
  let code = req.query.code;
  let appId = 'wx-xxxx'; //替换为自己的小程序Id
  let appSecret = 'daf-xxxxx'; //替换为自己的小程序生成的密钥
  ...
  let token = jwt.sign(person,'proudBai');
  console.log(token);
  //验证身份,将客户端传递的token进行反编译验证
  let verifyToken = jwt.verify(token,'proudBai')
